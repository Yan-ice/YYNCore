...
public class ScriptGenerator
{
    public static Dictionary<string, string> dicWidget = new Dictionary<string, string>()
    {
        ...
        {"m_text","Text"},
        {"m_fittext","AutoFitText"},
        {"m_focus","FocusTrigger"},
        ...
        {"m_anitext","AnimationText"},
        {"m_anim","Animator"},
        {"m_lbtn","LongPressButton"}
    };
    ...
    private static void Generate(bool includeListener)
    {
        ...
        if (root != null)
        {
            ...
            strFile.Append("/*该方法会在初始化前被UIWindow自动调用。*/\n");
            strFile.Append("\tprotected override void ComponentInit()\n");
            strFile.Append("\t{\n");
